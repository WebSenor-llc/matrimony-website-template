        ...
        >
          ...
          >
            ...
            >
              ...
              {/* Title */}
              <motion.h2
                className="mb-6 sm:mb-8 text-center text-lg sm:text-2xl font-normal text-gray-700"
                initial={{ opacity: 0, y: 20 }}
                animate={{ opacity: 1, y: 0 }}
              ...
              >
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-full rounded border border-gray-300 px-3 py-2.5 sm:py-2 text-sm focus:border-blue-50 focus:outline-none focus:ring-2 focus:ring-blue-300"
                    required
                  />
                </div>
                ...
                <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 sm:gap-0">
                  <label className="flex items-center gap-2 text-lg text-gray-600">
                    <input
                      ...
                      className="rounded border-gray-300 h-4 w-4" // Increased size
                    />
                    Stay Logged in
                    <HelpCircle size={20} className="text-gray-400" /> {/* Bigger icon */}
                  </label>
                  <button
                    type="button"
                    className="text-lg text-[#00bcd5] hover:text-[#00bcd5] self-start sm:self-auto hover:underline"
                  >
                    Forgot Password?
                  </button>
                </div>
                ...
                <motion.button
                  type="submit"
                  className="w-full rounded bg-[#00bcd5] py-3 sm:py-3 text-white font-medium hover:bg-[#00bcd5] transition-colors text-base cursor-pointer"
              ...
              >
                ...
                <motion.button
                  ...
                  className="font-medium text-gray-600 hover:text-gray-900 text-sm sm:text-lg"
