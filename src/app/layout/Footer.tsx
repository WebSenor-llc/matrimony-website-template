...
const Footer = () => {
  return (
    <footer>
      ...
      >
        <motion.div 
          className="grid grid-cols-2 gap-8 md:gap-2 lg:grid-cols-5"
          initial={{ opacity: 0 }}
        ...
        >
          ...
          {FOOTER_LINKS.map((section, sectionIndex) => (
            ...
            >
              <motion.h4 
                className="mb-3 text-xl font-bold text-[#212126]"
                ...
                {section.links.map((link, linkIndex) => (
                  ...
                  >
                    ...
                    >
                      <Link
                        href="#"
                        className="hover:text-[#212126] hover:underline transition-colors duration-200 text-lg"
                      >
                        {link}
                      </Link>
                    </motion.div>
